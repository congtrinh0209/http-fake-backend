...
module.exports = SetupEndpoint({
    ...
    urls: /* DOCFILE*/
        ...
        [
        {
            ...
            [{
                method: ['GET'],
                response: '/ddatasource/json/resourceworkspaces/case1/resourceworkspace_list.json',
                statusCode: 200
            },
            {
                method: ['PUT', 'PATCH'],
                response: '/ddatasource/json/resourceworkspaces/case1/resourceworkspace_2.json',
                statusCode: 200
            }
            ]
        },
        {
            ...
            [{
                method: 'POST',
                response: '/ddatasource/json/resourceworkspaces/case1/resourceworkspace_1.json',
                statusCode: 200
            }
            ]
        },
